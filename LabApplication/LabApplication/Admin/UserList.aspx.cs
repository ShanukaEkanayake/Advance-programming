...
namespace LabApplication.Admin
{
    public partial class UserList : System.Web.UI.Page
    {
        ...
        private void ShowUser()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No], UserId, Name, UserEmail, UserMobile, UserAddress from Registration";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(str);
                cmd = new SqlCommand("Delete from Registration where UserId = @id", con);
