...
namespace LabApplication.Admin
{
    public partial class JobList : System.Web.UI.Page
    {
        ...
        private void ShowService()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No], ServiceId, Headding, SCount, Qualification, 
ApplyBefore, DName, State, SContact, AddDate from LServices";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(str);
                cmd = new SqlCommand("Delete from LServices where ServiceId = @id", con);
