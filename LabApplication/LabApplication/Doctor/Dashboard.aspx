<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/Doctor.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="LabApplication.Doctor.Dashboard" %>
                    ...
                    <div class="card l-bg-blue-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="row-align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                                        <%Response.Write(Session["LServices"]);%> 
                                    </h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card l-bg-green-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="row-align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                                        <%Response.Write(Session["Appointments"]);%> 
                                    </h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card l-bg-orange-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="row-align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                                        <%Response.Write(Session["PMessages"]);%> 
                                    </h2>
                                </div>
                            </div>
                        </div>
