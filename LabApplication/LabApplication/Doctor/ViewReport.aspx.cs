...
namespace LabApplication.Doctor
{
    public partial class ViewReport : System.Web.UI.Page
    {
        ...
        private void ShowAppliedService()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No],aj.AppId,d.DName,aj.ServiceId,d.Headding,p.UserMobile, 
                    p.Name,p.UserEmail,p.UserReport from Appointments aj
                    inner join Registration p on aj.UserId = p.UserId
                    inner join LServices d on aj.ServiceId = d.ServiceId";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(str);
                cmd = new SqlCommand("Delete from Appointments where AppId = @id", con);
