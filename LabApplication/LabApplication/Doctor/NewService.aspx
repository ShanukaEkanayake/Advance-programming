<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/Doctor.Master" AutoEventWireup="true" CodeBehind="NewService.aspx.cs" Inherits="LabApplication.Doctor.NewService" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container pt-4 pb-4">
         ...
         <%--Take a Session Here--%>
         <h3 class="text-center"><%Response.Write(Session["Headding"]); %></h3>
         ...
         <div class="row mr-lg-5 ml-lg-5 mb-3">
             <div class="col-md-6 pt-3">
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="State is Required"
         ...
         <div class="row mr-lg-5 ml-lg-5 mb-3 pt-4">
             <div class="col-md-3 col-md-offset-2 mb-3">
                 <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="darkslateblue"
