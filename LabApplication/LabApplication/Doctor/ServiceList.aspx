<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/Doctor.Master" AutoEventWireup="true" CodeBehind="ServiceList.aspx.cs" Inherits="LabApplication.Doctor.ServiceList" %>
            ...
            <div class="col-md-12">
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SCount" HeaderText="NoOfSlots">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="ApplyBefore" HeaderText="Available Till" DataFormatString="{0:dd MMMM yyyy}">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="SContact" HeaderText="ContactNo">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>

                        <asp:BoundField DataField="AddDate" HeaderText="Created Date">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
